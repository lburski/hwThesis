\todo[inline]{Make sure all references and code in appendix fit inside page width}
\chapter{Specifcations in ZMathLang}
\label{app:other}
...
\subsection{ZCGa and ZDRa output}
\includepdf[pages={1}]{examples/bb/1n2comp.pdf}
\input{examples/bb/1n2.tex}
\subsection{Dependency and Goto Graphs}
\includegraphics[scale=0.7]{examples/bb/25a.png}
\includegraphics[scale=0.7]{examples/bb/25b.png}
\subsection{General Proof Skeleton}
\input{examples/bb/3.txt}
\subsection{Isabelle Proof Skeleton}
\input{examples/bb/4.thy}
\subsection{Isabelle Filled In}
\input{examples/bb/5.thy}
\subsection{Full Proof in Isabelle}
\input{examples/bb/6.thy}
...
\subsection{ZCGa and ZDra output}
\includepdf[pages={1}]{examples/nonworkzcga/1n2.pdf}
\todo[inline]{Add the output message when running zcga check and zdra check for nonworkingzcga}
...
\subsection{ZCGa and ZDra output}
\includepdf[pages={1}]{examples/nonworkzdra/1n2.pdf}
\todo[inline]{Add the output message when running zcga check and zdra check for nonworking zdra}
...
\todo[inline]{Add the output message when running zcga check and zdra check for semiform}

\section{An example of a specification which a changeSchema does not comply with the stateInvariants}
...
%\subsection{ZCGa and ZDra output}
%\includepdf[pages={1}]{examples/semiform/1n2.pdf}
\todo[inline]{Add an example of non working stateInvariants specification}
