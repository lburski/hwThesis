...
This thesis present a toolkit in order to translate a specification in a step by
step method with various safety checks a long the way. 
Our hypothesis is as follows:

\textbf{To what extent is breaking up the translation path from a formal/semi-formal specification into a theorem prover useful?}
