...
\item A gradual computerisation path from Z specifications (BirthdayBook, Vending Machine and Ed Curries book \todo[inline]{this should be a citation to Currie's book}) have been documented. These are the first translations from raw Z specifications to complete proofs done using the \gls{zmath} framework. Out of these translations we get new dependency graphs and proof skeletons for the individual specifications.
