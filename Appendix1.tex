...
The specifications translated using \gls{zmath} written here are the ones which a refered to in this thesis. The full range of examples of specifications can be found in \cite{mathlangexamples}.
