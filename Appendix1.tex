...
\noindent \includegraphics[scale=0.4]{examples/modulereg/6imagea.png}

\noindent \includegraphics[scale=0.4]{examples/modulereg/6imageb.png}

\noindent \includegraphics[scale=0.4]{examples/modulereg/6imagec.png}

\noindent \includegraphics[scale=0.4]{examples/modulereg/6imaged.png}

\noindent \includegraphics[scale=0.4]{examples/modulereg/6imagee.png}

\noindent \includegraphics[scale=0.4]{examples/modulereg/6imagef.png}
