...
\where 
\draline{SI1}{\text{\expression{\set{\dom \set{phoneNumbers}} = \set {\dom \set{persons}}}}}
\end{schema}}
...
\text{\Delta TelephoneDirectory} \\
\text{\declaration{\term{m}: \expression{NAME}}} \\
\text{\declaration{\term{p?}: \expression{TELEPHONE}}}
\where
\draline{PRE2}{
\text{\expression{\term{m} \notin \set{\dom \set{persons}}}} \\
\text{\expression{\term{p?} \notin \set{\ran \set{phoneNumbers}}}}} \\
\draline{PO3}{\text{\expression{\set{phoneNumbers'} = \set{\set{phoneNumbers \cup \set{\{\term{\term{m} \mapsto \term{p?}}\}}}}}}}
\end{schema}}
...
\text{\expression{\term{\term{n} \mapsto \term{p?}} \in \set{phoneNumbers}}}}\\
\draline{PO4}{
\text{\expression{\set{phoneNumbers'} = \set{\set{phoneNumbers} \setminus \term{\term{n} \mapsto \term{p?}}} \\
...
\draline{PO5}{
\text{\expression{\set{\ran \set{phoneNumbers'}} = \set{\ran \set{phoneNumbers} \setminus \set{\{\term{p}\}}}}}}\\
\end{schema}}
...
\begin{zed}
\draline{TS1}{TotalAddPerson == \text{\expression{(\text{AddPerson} \land \text{Success}) \\ \lor \text{AlreadyInDirectory}}}} \\
