...
\noindent\fbox{%
    \parbox{\textwidth}{%
    \texttt"{The first 2 steps of ZMathLang would be useful in ordering the requirements 
    in a logical order, this would greatly help the customer, however we don't 
    usually do proofs on our specifcations as it is too cexpensive both in
    manpower and costs so the last steps would be redundent" \\
    Bid Manager @ QinetiQ}
    }%
}
