...
\todo[inline]{Draw picture displaying how far automation goes with zmath and how far it goes the other way include auto and blast}

%--how far does the user get with the automation,
%--and what's the gap remaining, i.e. the complexity of the proof that still needs to be completed.
%--with a sketch of a picture to visualise it) and to draw on the case studies to answer this question
