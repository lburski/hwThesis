...
% requirements are shown in figure \ref{fig:zcgainformaltext}.

% \begin{figure}
%     \centering
%     \begin{subfigure}{.5\textwidth}
%       \centering
%       \includegraphics[width=.4\linewidth]{Figures/zcga/zcgaformal.png}
%     \caption{Compiled result of Figure \ref{fig:driverdeclared} 
%      \label{fig:compiledinformal}}
%     \end{subfigure}%
%     \begin{subfigure}{.5\textwidth}
%       \centering
%       \includegraphics[width=.4\linewidth]{Figures/zcga/driverdeclared.png}
%     \caption{Output result of running passing Figure \ref{fig:driverdeclared} 
%     through the ZCGa checker. \label{fig:zcgaautopilotresult}}
%     \end{subfigure}
%     \label{fig:zcgainformaltext}
%     \end{figure}
