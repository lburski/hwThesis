...
\begin{figure}[H]
    \hfill
    \subfigure{\includegraphics[width=8cm]{Figures/appendix/vmzcgao1.png}}
    \hfill
    \subfigure{\includegraphics[width=8cm]{Figures/appendix/vmzvgao2.png}}
    \hfill
\end{figure}
...
\begin{figure}[H]
    \hfill
    \subfigure{\includegraphics[width=9cm]{examples/vm/2imagea.png}}
    \hfill
    \subfigure{\includegraphics[width=9cm]{examples/vm/2imageb.png}}
    \hfill
\end{figure}
...
\begin{figure}[H]
    \hfill
    \subfigure{\includegraphics[width=7cm]{examples/vm/25a.png}}
    \hfill
    \subfigure{\includegraphics[width=7cm]{examples/vm/25b.png}}
    \hfill
\end{figure}
...
\begin{figure}[H]
    \hfill
    \subfigure{\includegraphics[width=7cm]{examples/vm/4a.png}}
    \hfill
    \subfigure{\includegraphics[width=7cm]{examples/vm/4b.png}}
    \hfill
\end{figure}
...
\begin{figure}[H]
    \hfill
    \subfigure{\includegraphics[width=7cm]{examples/bb/0oa.png}}
    \hfill
    \subfigure{\includegraphics[width=7cm]{examples/bb/0ob.png}}
    \hfill
\end{figure}
...
\begin{figure}[H]
    \hfill
    \subfigure{\includegraphics[width=9cm]{examples/bb/1imagea.png}}
    \hfill
    \subfigure{\includegraphics[width=9cm]{examples/bb/1imageb.png}}
    \hfill
\end{figure}
...
\begin{figure}[H]
    \hfill
    \subfigure{\includegraphics[width=7cm]{examples/bb/2a.png}}
    \hfill
    \subfigure{\includegraphics[width=7cm]{examples/bb/2b.png}}
    \hfill
\end{figure}
...
\begin{figure}[H]
    \hfill
    \subfigure{\includegraphics[width=7cm]{examples/bb/25a.png}}
    \hfill
    \subfigure{\includegraphics[width=7cm]{examples/bb/25b.png}}
    \hfill
\end{figure}
...
\begin{multicols}{2}
    \VerbatimInput{examples/bb/new3.txt}
    \end{multicols}
...
\begin{figure}[H]
    \hfill
    \subfigure{\includegraphics[width=7cm]{examples/bb/4a.png}}
    \hfill
    \subfigure{\includegraphics[width=7cm]{examples/bb/4b.png}}
    \hfill
\end{figure}
...
\begin{figure}[H]
    \hfill
    \subfigure{\includegraphics[width=7cm]{examples/nonworkzcga/0a.png}}
    \hfill
    \subfigure{\includegraphics[width=7cm]{examples/nonworkzcga/0b.png}}
    \hfill
\end{figure}
...
\begin{figure}[H]
    \hfill
    \subfigure{\includegraphics[width=7cm]{examples/semiform/5a.png}}
    \hfill
    \subfigure{\includegraphics[width=7cm]{examples/semiform/5b.png}}
    \hfill
\end{figure}
...
\subsection{Raw Latex output}
\label{app:sb0o}
%\includepdf[pages=-, scale=0.9, pagecommand={}]{examples/steamboiler/0.pdf}
...
\begin{figure}[H]
    \hfill
    \subfigure{\includegraphics[width=7cm]{examples/steamboiler/25a.png}}
    \hfill
    \subfigure{\includegraphics[width=7cm]{examples/steamboiler/25b.png}}
    \hfill
\end{figure}
...
\begin{figure}[H]
    \hfill
    \subfigure{\includegraphics[width=7cm]{Figures/appendix/zmath/zmatha.png}}
    \hfill
    \subfigure{\includegraphics[width=7cm]{Figures/appendix/zmath/zmathc.png}}
    \hfill
\end{figure}
