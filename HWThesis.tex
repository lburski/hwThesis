...
\input{Background}
\writechapter{Write background chapter}
% Z
% Weak type theory
% Mathlang for mathematics
% Current translations

%%\input{Design}
\writechapter{write design chapter}
%%\input{zcga}%-done

%%\input{zdra}%-done
%%\input{skeletons}%-done
%%\input{Formalising} %-done
%%\input{Interface}%-done
%%\input{Fullexample}%-done
%%\input{Analysis}%-done
