...
full input for this can be found in appendix \ref{app:vmspec}.
...
\centering
\centering
\includegraphics[scale=0.8, clip, trim=5.5cm 8cm 9.5cm 4cm, width=1.00\textwidth]{Figures/fullexample/1.jpg}
\includegraphics[scale=0.8, clip, trim=5.5cm 13cm 8.5cm 4cm, width=1.00\textwidth]{Figures/fullexample/2.jpg}
...
\end{BVerbatim}
\end{tiny}
\includegraphics[scale=0.5]{Figures/fullexample/zdra.png}
\vspace{-0.18in}
