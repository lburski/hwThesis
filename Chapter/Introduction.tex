...
%theoretical and applied mathematics it became more elabourate and complex.
...
%dervive all maths from logic. This ambitious project was the first stepping
...
%
%With many advances in performing digitalised calculations the computer was
...
%formally prove mathematics which was assited by a computer. AutoMath is
...
which assist the user in checking the correctnes of formal specifications, and
also assist users by partially automating the translation of the specfication
...
tool support built to translate specifcation into Isabelle. We summarise the
...
computerise a system specification. The \gls{zmath} framwork has stemmed from
...
annotates the specfication with grammatical labels and then uses the automatic
...
%
%We give a formal view on the dependecy and goto graphs using various
...
current goal e.g. Vampire\cite{vampire}, SPASS \cite{spass} and E \cite{e}. We
...
Chapter \ref{chap:gpsa2isa} summerises the path of how the general proof sketch
